                                ...
                                <ul class="wsus__button_area">
                                    ...
                                    <li>
                                        ...
                                        border-radius: 100%;" href="javascript:" class="add_to_wishlist"
                                           data-id="{{$product->id}}"><i class="fal fa-heart"></i>
                                        </a>
                                    </li>
                                    <li>
                                        ...
                                        padding: 7px 11px;
                                        margin-left: 7px;
                                        border-radius: 100%; background-color: #0088cc" class="btn"
            ...
            $('.message_modal').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('.message-box').val('');
                        $('.modal-body').append(`<div class="alert alert-success mt-2"><a href="{{ route('user.messages.list') }}" class="text-primary">Click here</a> for go to messenger.</div>`);
