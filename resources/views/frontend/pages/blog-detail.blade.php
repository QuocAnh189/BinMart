                    ...
                    <div class="wsus__main_blog">
                                            ...
                                            <div class="wsus__single_blog wsus__single_blog_2">
                                                ...
                                                <div class="wsus__blog_text">
                                                    ...
                                                    <div class="wsus__blog_text_center">
                                                        <a href="{{ route('blog.detail', $blogItem->slug) }}">{!!limitText($blogItem->title, 45)!!}</a>
                        ...
                        <div class="wsus__post_comment">
                            ...
                            @else
                                ...
                                <a class="common_btn" href="{{ route('auth.login') }}">Login</a>
                            @endif
                        </div>
                    </div>
                </div>
                        ...
                        <div class="wsus__blog_category">
                            ...
                            <ul>
                                @foreach ($categories as $category)
                                    <li>
                                        <a href="{{ route('blog.list', ['category' => $category->slug]) }}">{{ $category->name }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                            ...
                            @foreach ($moreBlogs as $blog)
                                <div class="wsus__blog_post_single">
                                    ...
                                    <div class="wsus__blog_post_text">
                                        <a href="{{ route('blog.detail', $blog->slug) }}">{{ limitText($blog->title, 35) }}</a>
                                        <p>
