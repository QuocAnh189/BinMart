            ...
            <form action="{{ route('admin.homepage-banner-section-two') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group">
                    ...
                    <label class="custom-switch mt-2">
                        <input {{ @$homepage_section_banner_two->banner_one->status == 1 ? 'checked' : '' }}
                ...
                <div class="form-group">
                    ...
                    <br>
                    <label class="custom-switch mt-2">
                        <input {{ @$homepage_section_banner_two->banner_two->status == 1 ? 'checked' : '' }}
                ...
                <div class="form-group">
                    <img alt="" src="{{ asset(@$homepage_section_banner_two->banner_two->banner_image) }}"
                        width="150px">
                </div>
