        ...
        <ul class="sidebar-menu">
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setActive(['admin.dropped-off']) }}">
                    ...
                    <li class="{{ setActive(['admin.out-for-delivery-orders']) }}">
                        <a class="nav-link" href="{{ route('admin.out-for-delivery-orders') }}">
                    ...
                    <li class="{{ setActive(['admin.canceled-orders']) }}">
                        <a class="nav-link" href="{{ route('admin.canceled-orders') }}">
                            All Canceled Orders
                        </a>
                    </li>
            ...
            <li class="dropdown {{ setActive(['admin.withdraw-method.*', 'admin.withdraw.index']) }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setActive(['admin.withdraw.index']) }}">
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setActive(['admin.admin-list.index']) }}">
                        <a class="nav-link" href="{{ route('admin.admin-list.index') }}">Admin Lists</a>
                    </li>
