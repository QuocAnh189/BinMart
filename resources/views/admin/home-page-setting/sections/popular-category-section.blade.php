...
<div aria-labelledby="list-profile-list" class="tab-pane fade show active" id="list-profile" role="tabpanel">
            ...
            <form action="{{ route('admin.popular-category-section') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control main-category" name="cat_one">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control sub-category" id="" name="sub_cat_one">
                                <option value="">select</option>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control child-category" id="" name="child_cat_one">
                                <option value="">select</option>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Category</label>
                            <select class="form-control main-category" id="" name="cat_two">
                                <option value="">Select</option>
                                @foreach ($categories as $category)
                                    <option
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            @endphp
                            <label>Sub Category</label>
                            <select class="form-control sub-category" id="" name="sub_cat_two">
                                <option value="">select</option>
                                @foreach ($subCategories as $subCategory)
                                    <option
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            @endphp
                            <label>Child Category</label>
                            <select class="form-control child-category" id="" name="child_cat_two">
                                <option value="">select</option>
                                @foreach ($childCategories as $childCategory)
                                    <option
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Category</label>
                            <select class="form-control main-category" id="" name="cat_three">
                                <option value="">Select</option>
                                @foreach ($categories as $category)
                                    <option
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            @endphp
                            <label>Sub Category</label>
                            <select class="form-control sub-category" id="" name="sub_cat_three">
                                <option value="">select</option>
                                @foreach ($subCategories as $subCategory)
                                    <option
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            @endphp
                            <label>Child Category</label>
                            <select class="form-control child-category" id="" name="child_cat_three">
                                <option value="">select</option>
                                @foreach ($childCategories as $childCategory)
                                    <option
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Category</label>
                            <select class="form-control main-category" id="" name="cat_four">
                                <option value="">Select</option>
                                @foreach ($categories as $category)
                                    <option
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            @endphp
                            <label>Sub Category</label>
                            <select class="form-control sub-category" id="" name="sub_cat_four">
                                <option value="">select</option>
                                @foreach ($subCategories as $subCategory)
                                    <option
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            @endphp
                            <label>Child Category</label>
                            <select class="form-control child-category" id="" name="child_cat_four">
                                <option value="">select</option>
                                @foreach ($childCategories as $childCategory)
                                    <option
